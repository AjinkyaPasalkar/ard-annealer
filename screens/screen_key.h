...
#define TFT_SCKEY_BTN_RECT_ROUND true
...
#define TFT_SCKEY_BTN7_RECT_ROUND TFT_SCKEY_BTN_RECT_ROUND
...
#define TFT_SCKEY_TXT1_RECT_ROUND TFT_SCKEY_BTN_RECT_ROUND
